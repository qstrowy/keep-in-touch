...
- [x] 3.4 Verify ZDR/no-log/no-fallback provider configuration and preview deployment with synthetic data — 9bd7604
- [x] 3.5 Confirm real-note use is gated on this verification and S-05 owns the manual full-history UI — 9bd7604
